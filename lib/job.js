...
var Job = module.exports = function Job(args) {
  ...
  delete args.agenda;
  //TaskId is a unique id to identify, usually a foreign key to be associated with other component part.
  // Process args
    ...
    self.save(function() {
      var jobCallback = function(err) {
        ...
        self.save(function (saveErr, job) {
          ...
          if (self.attrs.removeOnDone == true)
          {
            self.remove(function(error, count){
            //console.log(self.attrs.jobTag + "removed, total " + count + "error " + error);
            });
          }
        });
